...
#         urls = [
#             tag.get("href") for tag in soup.find_all(["a", "link"]) if tag.get("href")
#         ]
#
...
#             for char in url:
#                 encoded_urls.append(
#                     ord(char) if 32 <= ord(char) < 127 else self.special_tokens["None"]
#                 )
...
#             maxlen=512,
#             padding="post",
#             value=self.special_tokens["Padding"],
#         )
#         attention_mask = [
#             1 if i != self.special_tokens["Padding"] else 0 for i in padded_url[0]
#         ]
